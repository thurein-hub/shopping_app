            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="" class="form-control" value="<?php echo escape($result[0]['name']) ;?>">
                    </div>
                    <div class="form-group">
                        <label for="">Description</label><p style="color:red"><?php echo  empty($descriptionError) ? '' : '*'.$descriptionError ?></p>
                        <textarea name="description" id="" cols="30" rows="10" class="form-control"><?php echo escape($result[0]['description']); ?></textarea>
                    </div>
                    <?php
                    ...
                    <div class="form-group">
                        ...
                        <select name="category" id="" class="form-control">
                            ...
                            ?>
                            <?php if($result[0]['category_id'] == $catValue['id']) :?>
                            <option value="<?php echo $catValue['id'] ?>" selected><?php echo escape($catValue['name']) ?></option>
                            <?php else:?>
                            <option value="<?php echo $catValue['id'] ?>"><?php echo escape($catValue['name'] )?></option>
                            <?php endif;?>
                            <?php
                            }?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="quantity" id="" class="form-control" value="<?php echo escape($result[0]['quantity']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="">Price</label><p style="color:red"><?php echo  empty($priceError) ? '' : '*'.$priceError ?></p>
                        <input type="number" name="price" id="" class="form-control" value="<?php echo escape($result[0]['price']); ?>">
                    </div>
                    <div class="form-group">
                        <label for="">Image</label><p style="color:red"><?php echo  empty($imageError) ? '' : '*'.$imageError ?></p>
                        <img src="images/<?php echo $result[0]['image']; ?>" alt="" width="200"><br><br>
                        <input type="file" name="image" id="" class="form-control" value="<?php echo $result[0]['image']; ?>">
                    </div>
                    <div class="form-group">
